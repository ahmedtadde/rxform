...
export type SubmissionHandler = (values: FormValues, errors: FormErrors, status: FormStatus, dispatch: FormDispatch) => void | Promise<void>;
...
export interface RxFormConfig {
    ...
    values: {
        ...
        hooks?: {
            start?: (evt: Event) => void | Promise<void>;
            end?: (payload?: FormValuesReducerPayload) => void | Promise<void>;
        }
    },
    errors: {
        state: FormErrors,
        ...
        hooks?: {
            start?: (values?: FormValues, errors?: FormErrors, status?: FormStatus) => void | Promise<void>;
            end?: (payload?: { error: string; input: any; type: string }) => void | Promise<void>;
        }
    }
}
